...
describe("deposit test", () => {
  ...
  it("deposit test, add the same liquidity and check the correctness of the values with and without transfer fees", async () => {
    ...
    console.log("poolState.token0Vault: ", poolState.token0Vault.toString())
    console.log("poolState.token1Vault: ", poolState.token1Vault.toString())
    ...
    const liquidity = new BN(100000000000);
    await deposit(
      program,
      owner,
      poolState.ammConfig,
    ...
    console.log("poolVault0TokenAccountBefore.amount: ", poolVault0TokenAccountBefore.amount)
    console.log("poolVault0TokenAccountAfter.amount: ", poolVault0TokenAccountAfter.amount)
    console.log("poolVault1TokenAccountBefore.amount: ", poolVault1TokenAccountBefore.amount)
    console.log("poolVault1TokenAccountAfter.amount: ", poolVault1TokenAccountAfter.amount)
